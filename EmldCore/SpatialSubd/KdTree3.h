...
// Box<Vec3<T> >( *iter ) and (*iter) respectively.
//
...
// {
//     Imath::Box3f operator()( const MyThing *a ) const
//     { return a->bounds(); }
// };
//
// struct MyThingsSortPt
// {
//     Imath::Vec3f operator()( const MyThing *a ) const
//     { return a->center(); }
// };
//
//-*****************************************************************************
...
//
// This is basically a sorting tool. It does not own the things
// it points to.
// I'm not 100% happy with the "const" logic.
//-*****************************************************************************
//-*****************************************************************************
//-*****************************************************************************
...
public:
    ...
    //     // traversing
    //     bool validBounds( const B3T &bnds );
    //
    //     // Traverse a leaf

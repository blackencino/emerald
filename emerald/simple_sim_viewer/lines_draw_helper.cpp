#include <emerald/simple_sim_viewer/lines_draw_helper.h>

namespace emerald {
namespace simple_sim_viewer {

//-*****************************************************************************
LinesDrawHelper::LinesDrawHelper(bool i_dynamic,
                                 size_t i_numPoints,
  ...
  , m_uvVboIdx(-1) {
    ...
    // OPENGL INIT
    //-*************************************************************************
    util_gl::CheckErrors("line draw helper init before anything");
...
//-*****************************************************************************
void LinesDrawHelper::update(size_t i_numPoints,
                             const V3f* i_vtxPosData,
                             const V3f* i_vtxNormData,
                             const V3f* i_vtxColData,
                             const V2f* i_vtxUvData) {
...
void LinesDrawHelper::draw(const GLCamera& i_cam) const {
    ...
    // Draw the arrays
    glDrawArrays(GL_LINES, 0, static_cast<GLsizei>(m_numPoints));
